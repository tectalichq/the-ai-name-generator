...
<html lang="{{ str_replace('_', '-', app()->getLocale()) }}">
    <head>
        ...
        <title>Tectalic Business Name and Tagline Generator</title>
        ...
        <div class="relative flex items-top justify-center min-h-screen bg-gray-100 dark:bg-gray-900 sm:items-center py-4 sm:pt-0">
            ...
            <div class="max-w-6xl w-full mx-auto sm:px-6 lg:px-8">
                <div class="flex justify-center pt-8 sm:justify-start sm:pt-0">
                    <a href="/"><img src="https://tectalic.com/img/tectalic-logo.svg" alt="Tectalic Logo" class="max-w-[250px]" ></a>
                </div>

                <div class="mt-8 bg-white dark:bg-gray-800 overflow-hidden shadow sm:rounded-lg p-6">
                    <h2 class="text-lg font-bold">{{ __('Business Name and Tagline Idea Generator') }}</h2>
